...
<head>
  ...
  <title>The Continuing Adventures of Dan Whitlow</title>
...
<!--<div class="navbar navbar-inverse navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container">
      <a class="brand" href="#">Whats Dan up to?</a>
    </div>
  </div>
</div>-->
...
<div class="container">
  ...
  <div class="row">
    <div class="span4">
      ...
      <p>What does Dan need to Know?</p>


      <form method="post">
        <input type="hidden" name="operation" value="insertItem">
        <textarea name="message" placeholder="Serious Business" class="span4"></textarea><br/>
  ...
  <div class="span4">
    ...
    <div class="span4" id="subscriptions">
      <h2>Subscriptions</h2>
...
x.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
<script src="/static/bootstrap/js/bootstrap.min.js"></script>
</body>
</html>
pt src="/static/bootstrap/js/bootstrap.min.js"></script>
</body>
</html>
t>
</body>
